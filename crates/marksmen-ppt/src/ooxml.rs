...
pub const ENVELOPE_RELS: &str = r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
<p:sldMaster xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main">
  <p:cSld>
    <p:bg><p:bgPr><p:solidFill><p:srgbClr val="ffffff"/></p:solidFill></p:bgPr></p:bg>
    <p:spTree>
...
pub const SLIDE_TEMPLATE: &str = r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
