...
Inline equations like limx→∞f(x) blend seamlessly with the baseline.
...
![Architecture Diagram](./diagram1.svg)
...
Because `marksmen` leverages Typst, we can seamlessly write e(ipi)+1=0 in the middle of text, and be confident that it renders beautifully on a completely separated page.