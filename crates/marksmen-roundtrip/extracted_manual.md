**Marksmen Feature Demonstration**

Ryan Clanton, Elite Systems Architect
...
- **Line breaks**: Forced HTML break  is translated correctly.*Note: Arbitrary *`<div style="padding: 2px">`* blocks are ignored, preserving architectural invariants against empirical DOM approximations.*
